...
//}
//
//static struct filter **create_random_filters(uint16_t num_of_filters,
//                                             uint64_t num_of_attrs, enum data_type *table_scheme) {
...
//    column_list_push(column_list, column1);
//    column_list_push(column_list, column2);
//
...
//
//    struct table *table = create_table(table_name_size, my_table_name, num_of_columns, column_list);
//
//    add_table(db, table);
//
...
//        page_offset page_offset = (struct page_offset) {.offset = 0};
//        void **data = read_tuple_data_from_file(table->table_scheme, num_of_columns, data_file);
//        uint64_t num_of_attributes = num_of_columns;
//        enum data_type *table_scheme = table->table_scheme;
//        struct tuple *tuple = create_tuple(page_offset, data, num_of_attributes, table_scheme);
...
//
//    struct page *page = create_empty_page(offset, prev_page, next_page);
//
